/*
? Jedná se o kód knihovny multiselect.dart (https://github.com/TaimoorHassan/multiselect/blob/master/lib/multiselect.dart), který jsem však potřeboval upravit pro zalamování textu, takže jsem byl nucen udělat vlastní widget obsahující totožný kód s malými úpravami
*/
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            ), //? Jediná velká změna knihovny - zalamování textu :/
          ],
        ),
      ),
    );
